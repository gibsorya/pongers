defmodule PongersWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PongersWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PongersWeb.Gettext, "errors", msg, opts)
    end
  end
